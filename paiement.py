...
class Paiement(QMainWindow):
   ...
   def widgets(self):
      #========= TABLE
      self.main_frame=QGroupBox('TABLEAU DES PAIEMENTS',self)
      ...
      self.lab_cal.setStyleSheet("""
                                  background-color:transparent;color:#000;font-family: Time;font-style:italic;font-size:15pt;
                                  font-weight:bold
                                  """)
      self.lab_cal.move(10,520)
      self.lab_cal.resize(900,20)
      self.lab_cal.setText('QUANTITE TOTALE: 0  --  RECETTE TOTALE: 0 FCFA')
      ...
      #_________________________________________ALL ROW
      self.btn_all=QPushButton('TOUT AFFICHER',self.dash2_paiement)
      self.btn_all.setStyleSheet("""
                                  ...
                                  font-weight:bold;border-radius:5px}
                                  """)
      self.btn_all.setCursor(QCursor(Qt.PointingHandCursor))
      self.btn_all.clicked.connect(self.load_all)
      self.btn_all.move(10,260)
      self.btn_all.resize(150,20)
      #_________________________________________BOISSONS ROW
      self.btn_boisson=QPushButton('BOISSONS',self.dash2_paiement)
      ...
      self.btn_boisson.clicked.connect(self.load_boisson)
      self.btn_boisson.move(10,280)
      self.btn_boisson.resize(150,20)
         ...
         try:
            ...
            if self.bdd:
               try:
                  ...
                  #==== HEADER LABELS
                  self.headers=['ID_PAIEMENT','NOM','QUANTITE','PRIX','REDUCTION','DATETIME','TYPE','CATEGORIE',
                  ...
                  self.tableWidget.setHorizontalHeaderLabels(['ID_PAIEMENT','NOM','QUANTITE','PRIX','REDUCTION','DATETIME','TYPE','CATEGORIE',
                                                              'NOM_CLIENT','CNIB_CLIENT','ADRESSE_CLIENT','ID_PRODUIT',
                                                              'CODE_PRODUIT','PHOTO'])
                  ...
                  self.result=self.cursor.execute(""" SELECT  id,nom,quantite,prix,reduction,datetime,type,categorie,
                                                                nom_client,cnib_client,adresse_client,
                                                                         id_produit,code_produit,photo  FROM paiements """)
